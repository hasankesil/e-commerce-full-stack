    ...
    return (
        <div className="single-tabs">
            <ul className="tab-list">
                <li>
                    <a href="#" className={`tab-button active ${activeTab === "desc" ? "active" : "" } `} data-id="desc" onClick={(e) => handleTabClick(e, "desc")}>
                        Description
                    </a>
                </li>
                <li>
                    <a href="#" className={`tab-button active ${activeTab === "info" ? "active" : ""} `} onClick={(e) => handleTabClick(e, "info")}>
                        Additional information
                    </a>
                </li>
                <li>
                    <a href="#" className={`tab-button active ${activeTab === "reviews" ? "active" : ""} `} data-id="reviews" onClick={(e) => handleTabClick(e, "reviews")}>
                        Reviews
                    </a>
                </li>
            </ul>
            <div className="tab-panel">
                <div className={`tab-panel-descriptions content active ${activeTab === "desc" ? "active" : ""} `} id="desc">
                    <p>
